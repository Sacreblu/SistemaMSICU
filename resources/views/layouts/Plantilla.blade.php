                ...
                <ul class="navbar-nav mr-auto">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="{{ url('') }}">Productos LGAC</a>
                            <a class="dropdown-item" href="{{ url('') }}">Productos LGAC por Movilidad</a>
                            <a class="dropdown-item" href="{{ url('/Trabajos_Recepcionales') }}">Trabajos Recepcionales</a>
                        </div>
                    </li>
                    <li class="nav-item">
